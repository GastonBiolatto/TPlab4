...
namespace TPlab4.Controllers
{
    public class DepartamentoController : Controller
    {
        ...
        public DepartamentoController(TPlab4Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Departamentos != null ? 
                          ...
                          Problem("Entity set 'TPlab4Context.Departamentos'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TPlab4Context.Departamentos'  is null.");
            }
            var departamento = await _context.Departamentos.FindAsync(id);
            if (departamento != null)
            {
